        ...
        .end((err, res) => {
          request(app)
            ...
            .end((err, res) => {
              ...
              expect(res.body).toHaveProperty("TukangCukurId")
              ...
              expect(res.body.TransactionDetails[0]).toHaveProperty("VarianId")
              expect(res.body.TransactionDetails[0]).toHaveProperty("jumlah")
              expect(res.body.TransactionDetails[0]).toHaveProperty("Varian")
              expect(res.body.TransactionDetails[0].Varian).toHaveProperty("id")
              expect(res.body.TransactionDetails[0].Varian).toHaveProperty("jenisCukur")
              expect(res.body.TransactionDetails[0].Varian).toHaveProperty("hargaCukur")
              expect(res.body.TransactionDetails[1]).toHaveProperty("TransactionId")
              expect(res.body.TransactionDetails[1]).toHaveProperty("VarianId")
              expect(res.body.TransactionDetails[1]).toHaveProperty("jumlah")
              expect(res.body.TransactionDetails[1]).toHaveProperty("Varian")
              expect(res.body.TransactionDetails[1].Varian).toHaveProperty("id")
              expect(res.body.TransactionDetails[1].Varian).toHaveProperty("jenisCukur")
              expect(res.body.TransactionDetails[1].Varian).toHaveProperty("hargaCukur")
              done()
            });
        });
        });
